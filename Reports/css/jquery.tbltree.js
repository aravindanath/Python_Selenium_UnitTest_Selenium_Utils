...
(function($) {
	 $.widget( "ui.tbltree", {
      ...
      options: {
		...
		levelPickerTemplate: '<div class="tbltree-level-pickers">								<span id="0" class="tbltree-level-item">[1]</span>&nbsp;								<span id="1" class="tbltree-level-item">[2]</span>&nbsp;								<span id="2" class="tbltree-level-item">[3]</span>&nbsp;								<span id="3" class="tbltree-level-item">[4]</span>&nbsp;							  </div>',
